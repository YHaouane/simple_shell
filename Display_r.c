...
/** by ZACKTLEHA AND YHaouane */

/**
 * print_exec - add executable to buffers
 * @buff: buffers
 * @exec: executable names
 * @n: error numbers
 *
...
/**
 * print_command - adds command to buffers
 * @buff: buffers
 * @cmd: command
 * @i: buff last index
 *
...
/**
 * print_error - adds error to buffers
 * @buff: buffers
 * @error: error message
 * @i: buffer last index
 *
